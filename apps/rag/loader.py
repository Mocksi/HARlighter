...
def store_in_pinecone(vector_store, docs):
    ...
    return VectorStoreIndex.from_documents(docs, storage_context=storage_context, service_context=service_context)
...
def parse_args():
    ...
    parser.add_argument(
        "--index_name", type=str, required=False, help="Name of the Pinecone index", default="web-capture"
    )
